...
//var minibnHref = new Array("OSwwLDE=","MTAsMCwx","NiwwLDE=","OCwwLDE=");
//var minibnSrc = new Array("bns02.gif","bns03.gif","bns06.gif","ceremony.gif");
//var minibnName = new Array("阪急交通社","埼玉縣信用金庫","ファミリー引越センター","セレモニー");
//var miniNum = new Array(0,1,2,3);
var minibnHref = new Array("MTAsMCwx","NiwwLDE=","OCwwLDE=", "MjgsMCww");
var minibnSrc = new Array("bns03.gif","bns06.gif","ceremony.gif", "mufg.gif");
var minibnName = new Array("埼玉縣信用金庫","ファミリー引越センター","セレモニー", "MUFGカード");
var miniNum = new Array(0,1,2,3);
